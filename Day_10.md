...
### Arbitrary Arguments
Arbitrary arguments also known as *args allow a function to accept any number of positional arguments. This can be useful when you don't know how many arguments will be passed to the function or when you want to write a function that can accept a variable number of arguments.
```python
def own_max(*nums):
